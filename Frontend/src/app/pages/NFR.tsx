...
import { nfrs, getCasesByNfrId, getNfrById, getCasesByMantisId, updateNfr } from "../data/apiClient";
...
export function NFR() {
  ...
  const relatedCases = selectedNfr ? getCasesByMantisId(selectedNfr.mantisId) : [];
            ...
            <tbody className="divide-y divide-gray-200">
              {sortedNfrs.map((nfr) => (
                ...
                >                  <td className="px-4 py-4 text-center" onClick={(e) => e.stopPropagation()}>
                  ...
                  </td>                  <td className="px-6 py-4 text-sm font-medium text-[#E31937] whitespace-nowrap">{nfr.recordId}</td>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between rounded-t-xl">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setSelectedNfr(null)} className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-3 mb-6">
                  {selectedNfr.history && selectedNfr.history.length > 0 ? (
                    selectedNfr.history.map((entry, index) => (
